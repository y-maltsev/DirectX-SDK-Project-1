...
{    //biped,char skining, char animation
	// Create a frame
        ...
        LPD3DXMESHCONTAINER *ppNewMeshContainer) 
{
	...
	*ppNewMeshContainer = NULL;
	...
	for(DWORD i=0;i<pMeshContainer->NumMaterials;i++){
		pMeshContainer->pMaterials9[i]=pMaterials[i].MatD3D;
		pMeshContainer->pMaterials9[i].Ambient= pMeshContainer->pMaterials9[i].Diffuse;
